...
async def get_videos(
    request: PromptRequest, limit: int = Query(10, ge=1), distance: float = Query(0.40, ge=0, le=1)
) -> list:
    ...
    async with app.state.db_pool.acquire() as connection:
        try:
            ...
            results = await connection.fetch(select_query, vector_string, distance, limit)
